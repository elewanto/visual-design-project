function drawLineChartUS(error, dataUS, dataOhio) {
  ...
  chartGroup.append('g')
            ...
            .attr('id', '#chartTitle')
            .append('text')
            .text('U.S. Opioid Mortality Rates per 100,000 Population (1999 - 2015)')
            .attr('class', 'title');
  ...
  var yScale = d3.scaleLinear().domain([0, 50]).range([chartHeight + marginBottom, marginTop]);
...
function drawLineChartOhio(error, dataUS, dataOhio) {
  ...
  chartGroup.append('g')
            ...
            .attr('id', '#chartTitle')
            .append('text')
            .text('Ohio Counties Opioid Mortality Rates per 100,000 Population (1999 - 2015)')
            .attr('class', 'title');
  ...
  // normalize ranges
  var xScale = d3.scaleLinear().domain([1999, 2015]).range([marginLeft, chartWidth + marginLeft]);
  var yScale = d3.scaleLinear().domain([0, 100]).range([chartHeight + marginBottom, marginTop]);
...
function partialDrawLineChartUS(error, dataUS, dataOhio) {
  ...
  chartGroup.append('g')
            ...
            .attr('id', '#chartTitle')
            .append('text')
            .text('U.S. and Ohio Opioid Mortality Rates per 100,000 Population (1999 - 2015)')
            .attr('class', 'title');
